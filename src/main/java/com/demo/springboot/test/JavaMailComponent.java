...
/**
 * @description 整合 JavaMail
 * @author lzq
 * @date 2018年4月4日 下午6:52:32
 */
@Component
...
public class JavaMailComponent {
    ...
    private String send(String email, String text) throws MessagingException, UnsupportedEncodingException, javax.mail.MessagingException {
